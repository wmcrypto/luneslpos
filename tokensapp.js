 ...
 *     - assentIdtoken: assentId the token you want to distribute
 ...
 *     - percentageOfFeesToDistribute: percentage of token amount per distributed rate, Ex: 100 = 1 token for 1 generated Lunes.
 *     - blockStorage: file for storing block history
 */
var assentIdtoken = "AyVLgNLBNRVQCqtiADQ27viPwAdpciGPesDgYtXk3tD9";
var config = {
    address: '37td4GxgrdsZ9zNCkwmdpciXev9bZrgDBwY',
    alias: 'legion.cash',
    startBlockHeight: 0,
    endBlock: 218230,
    distributableWfnPerBlock: 0,
    filename: 'centurion.json',
    node: 'http://localhost:5555',
    percentageOfFeesToDistribute: 1000000,
    blockStorage: 'blockstoken.json'
